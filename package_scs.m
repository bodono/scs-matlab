function package_scs()
    ...
    % Windows, Linux, and Intel Mac binaries retain the R2022b baseline.
    % Native Apple Silicon MATLAB itself is available only from R2023b.
    opts.MinimumMatlabRelease = 'R2022b';

    % Disable MATLAB Online as this toolbox relies on native MEX binaries.
    % R2026a's ToolboxOptions uses one architecture-neutral Mac field;
    % the package contains both mexmaci64 and mexmaca64 binaries.
    ...
    opts.ToolboxMatlabPath = {fullfile(projectRoot, 'matlab')};
    ...
    excludeList = { ...
        ...
        fullfile(projectRoot, 'make_scs.m'), ...
